...
1. prompting_document.txt -- describes the related files (in the 'project descritption folder' directory) and instructions given to the LLM that we used (Claude Sonnet 4.6) to vibe code our project.
